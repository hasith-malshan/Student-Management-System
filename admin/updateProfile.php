<?php
session_start();
//checking if there is a sessionb belongs to admin
...
//checking wheather if there is  session belongs to admin
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4 border border-4 p-3">
                                ...
                                <div class="row d-flex justify-content-center">
                                    <?php
                                    //cheking if there is a image path in the session
                                    if ($_SESSION["admin"]["file_path"] != "") {
                                        $img = "../" . $_SESSION["admin"]["file_path"];
                                    } else {
                            ...
                            <!-- Loading the data of the admin -->
                            <div class="col-12 col-md-8  p-3">
                                <label for="">Your Email</label> <input type="text" class="form-control" value="<?php echo $_SESSION['admin']['email'] ?>" disabled><br />
                                <label for="">User name</label> <input type="text" id="username" value="<?php echo $_SESSION['admin']['username'] ?>" class="form-control"><br />
                                <label for="">Mobile number</label> <input type="text" id="c_num" value="<?php echo $_SESSION['admin']['c_num'] ?>" class="form-control"><br />
                                <label for="">Password</label> <input type="password" id="" value="<?php echo $_SESSION['admin']['passward'] ?>" class="form-control" disabled><br />
                                <div class="row justify-content-center">
                                    <button class="btn btn-success col-4" onclick="updateData('admin')">update Data</button>
                                </div>
...
<?php
    ...
    //if there is no session user will be rederected to the index page
?>
    <script>
