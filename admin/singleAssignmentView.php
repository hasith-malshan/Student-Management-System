<?php
// this page is used to show the results of a single assignment
session_start();
//session start
...
if (isset($_SESSION["admin"]["id"])) {
    ...
    if (!isset($_GET["id"])) {
        //checking wheather if there is not a id from the previes page wich is belong to a assignment. then page will be rederected to a student marks page. 
?>
        <script>
    ...
    <?php
        ...
        // if there is a assignent id which send using the GET methood that assignment id will be assigned to the $assignment_id
    ...
    ?>
        ...
        <head>
            ...
            <title>Admin - Assignment Marks View</title>
                                    ...
                                    <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                        <table class="table my-0" id="dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <!-- adding data to a table row using the for loop -->
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <lable class=""><?php echo $searchAssignmentsData["marks"] ?> </label>
                                                            </td>
                                                        </tr>
                                                <?php
                                                    }
