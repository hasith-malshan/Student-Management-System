...
<body class="bg-gradient-primary">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-none d-lg-block bg-password-image admin2">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Welcome to ADMIN login</h1>
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user mb-3" id="passward" placeholder="Enter passward">
                                    </div>
                                    ...
                                    <button class="btn btn-primary btn-user btn-block" onclick="login('admin');">
                                        Login to the system
                                    </button>
    ...
    <div class="modal fade " id="verifyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Verify your Academic Officer Account</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success" onclick="verification('officer');">Verify Account</button>
                </div>
            </div>
        </div>
    </div>
