                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex justify-content-between align-items-center mb-4">
                            <h3 class="text-dark mb-0">Dashboard</h3><a class="btn btn-danger btn-sm d-none d-sm-inline-block" role="button" href="../logOut.php"><i class="fa fa-sign-out" aria-hidden="true"></i>
                                &nbsp; LOG OUT</a>
                        </div>
