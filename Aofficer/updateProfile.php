...
?>
    ...
    <head>
        ...
        <title>Academic Officer - Update Profile</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <!-- loading data in to the fields -->
                            <div class="col-12 col-md-8  p-3">
                                <label for="">Your Email</label> <input type="text" class="form-control" value="<?php echo $_SESSION['officer']['email'] ?>" disabled><br />
                                <label for="">User name</label> <input type="text" id="username" value="<?php echo $_SESSION['officer']['username'] ?>" class="form-control"><br />
                                <label for="">First Name</label> <input type="text" id="fname" value="<?php echo $_SESSION['officer']['fname'] ?>" class="form-control"><br />
                                <label for="">Last Name</label> <input type="text" id="lname" value="<?php echo $_SESSION['officer']['lname'] ?>" class="form-control"><br />
                                <label for="">Mobile number</label> <input type="text" id="c_num" value="<?php echo $_SESSION['officer']['c_num'] ?>" class="form-control"><br />
                                <label for="">Password</label> <input type="password" id="" value="<?php echo $_SESSION['officer']['passward'] ?>" class="form-control" disabled><br />
                                <div class="row justify-content-center">
                                    <button class="btn btn-success col-4" onclick="updateData('officer')">update Data</button>
                                </div>
